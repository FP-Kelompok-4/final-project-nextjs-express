...
const ListTopRateProperty = () => {
  ...
  const duplicatedSlides =
    ListSlide.length < 3
      ? [...ListSlide, ...ListSlide.slice(0, 6 - ListSlide.length)]
      : ListSlide;
  ...
  return (
    <div className="flex flex-col gap-6 px-6 md:px-10 xl:px-20">
      ...
      {isThreeTopPropertyLoading ? <div className="w-full"><Loader2 className="animate-spin" size={24} /> </div> : <div className="group/navigation relative">
        <Swiper
